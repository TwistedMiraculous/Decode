...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 0; //1265.8422257764855; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 0;//-27.623999427870476; // x position of the perpendicular encoder (in tick units)
    }
