...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2139.6505643242863; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1222.6966889681096; // x position of the perpendicular encoder (in tick units)
    }
